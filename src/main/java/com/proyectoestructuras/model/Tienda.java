...
public class Tienda implements Serializable {
    ...
    public void crearCanciones() {
        ...
        Cancion ca2 = new Cancion("2", "The Unforgiven", "Metallica", new Image(String.valueOf(getClass().getResource("/imagenes/theUnforgiven.jpg"))), "1991", "6:28", "Rock", "https://www.youtube.com/watch?v=Ckom3gf57Yw", "Metallica", 1);
         ...
         Cancion ca21 = new Cancion("21", "Dreams of Loving", "Synthwave Sensations", new Image(String.valueOf(getClass().getResource("/imagenes/dreamsOfLoving.jpg"))), "2023", "4:30", "Electrónica", "https://ejemplo.com/cancion1.mp3","The Human League", 20);
         Cancion ca22= new Cancion("22", "Future Pulse", "Digital Paradigm", new Image(String.valueOf(getClass().getResource("/imagenes/futurePulse.jpg"))), "2022", "5:12", "Electrónica", "https://ejemplo.com/cancion2.mp3", "Scandroid", 21);
         Cancion ca23 = new Cancion("23", "Neon Nights", "Retro Electro Vibes",new Image(String.valueOf(getClass().getResource("/imagenes/neonNights.jpg"))), "2021", "3:58", "Electrónica", "https://ejemplo.com/cancion3.mp3", "Kraftwerk", 22);
         Cancion ca24 = new Cancion("24", "Synthetic Love", "Cyber Beats",new Image(String.valueOf(getClass().getResource("/imagenes/syntheticLove.jpg"))), "2023", "6:02", "Electrónica", "https://ejemplo.com/cancion4.mp3","Trevor Something", 23);
         Cancion ca25 = new Cancion("25", "Technoir", "Digital Evolution",new Image(String.valueOf(getClass().getResource("/imagenes/technoir.jpg"))), "2022", "4:45", "Electrónica", "https://ejemplo.com/cancion5.mp3","Perturbator", 24);
    ...
    public int encontrarIndice(String nombre) {
        ...
        for (int i = 0; i < listaCanciones.size(); i++) {
            if (listaCanciones.get(i).getNombre().equalsIgnoreCase(nombre)) {
                indice = listaCanciones.get(i).getIndice();
            }
        }
        return indice;
    }
